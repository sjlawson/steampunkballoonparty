# py2exe setup file.
# execute from command line: python py2exe_setup.py py2exe
...
AUTHOR_URL = "http://www.vessel7productions.org/"
PRODUCT_NAME = "Balloon Steamer"
SCRIPT_MAIN = "spbp.py"
...
setup(
    windows=[
        {
            "script": SCRIPT_MAIN,
            "other_resources": [("VERSIONTAG", 1, VERSIONSTRING)],
        }
    ],
    options={
        "py2exe": {
...
if os.path.exists("dist/tcl84.dll"):
    os.unlink("dist/tcl84.dll")
if os.path.exists("dist/tk84.dll"):
    os.unlink("dist/tk84.dll")
